...
public class Run {
    ...
    public void RunTask(){
        ...
        System.out.println("Wybierz lab:");
        ...
        switch (wyborLab){
            case 1:{
                ...
                switch (wyborZad){
                    ...
                    default: 
                        System.out.println("Nie ma takiego zadania"); break;}
            } break;
            case 2:{
                System.out.println("Zadanie 1");
                System.out.println("Zadanie 2");
                ...
                switch (wyborZad){
                    case 1:
                        tasks.rownanieKwad(); break;
                    default: 
                        System.out.println("Nie ma takiego zadania"); break;
            } break;}
            default: System.out.println("Nie ma takiego laba"); break;
